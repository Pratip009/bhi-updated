...
const socials = [
  {
    name: 'facebook',
    link:"https://www.facebook.com/people/Bright-Horizon-Institute/61589229856640/"
  },
  {
    name: 'tiktok',
    link:"https://www.tiktok.com/@brighthorizoninstitute5?is_from_webapp=1&sender_device=pc"
  },
  {
    name: 'instagram',
    link:"https://www.instagram.com/brighthorizoninstitute_bhi/"
  },
  {
    name: 'linkedin',
    link:"https://www.linkedin.com/company/bright-horizon-institute/?viewAsMember=true"
  }
...
const Contact = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setFormData({ name: '', email: '', contact: '', message: '', optIn: false });
    } catch (err: any) {
  ...
  const contactInfo = [
    {
      ...
      title: 'Our Address',
      details: ['910 Bergen Ave Floor 3', 'Jersey City, New Jersey', 'NJ 07306']
    },
    {
      icon: (
        <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: 'Email Us',
      details: ['contactus@bhilearning.com ']
    },
    {
      icon: (
        <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <main className="min-h-screen bg-gray-200 overflow-x-hidden">
      {/* Hero Section */}
      <section className="relative bg-[#303079] py-16 sm:py-24 overflow-hidden">
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-10 shadow-xl shadow-gray-200/50">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <div className="group">
                  ...
                  {/* Opt-in Checkbox + Text - Now Optional */}
                  <div className="flex items-start gap-3 bg-gray-50 p-4 rounded-lg border border-gray-200 mt-4">
                    <input
                      type="checkbox"
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                      <span className="font-semibold">(Optional)</span> By opting in for text messages, you agree to receive appointment reminders
                      and important updates from{" "}
                      <span className="font-semibold">Bright Horizon Institute</span>{" "}
                      at the number provided. Message frequency varies. Msg & data rates may apply.
                      Reply <span className="font-semibold">STOP</span> to unsubscribe. Reply{" "}
                      <span className="font-semibold">HELP</span> for help.
                      View our{" "}
                      <a href="/privacy-policy" className="text-blue-600 underline">Privacy Policy</a>{" "}
                      and{" "}
                      <a href="/terms-conditions" className="text-blue-600 underline">Terms & Conditions</a>.
                    </p>
            ...
            <div className="lg:sticky lg:top-8">
              <div className="bg-white rounded-2xl sm:rounded-3xl p-2 sm:p-3 shadow-xl shadow-gray-200/50 mb-6 sm:mb-8">
                <div className="rounded-xl sm:rounded-2xl overflow-hidden">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3023.456390180939!2d-74.0674532245007!3d40.72998203651556!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c257327be33e3f%3A0x7e5d074cdbd803f7!2s910%20Bergen%20Ave%20%23%203%2C%20Jersey%20City%2C%20NJ%2007306%2C%20USA!5e0!3m2!1sen!2sin!4v1770134320624!5m2!1sen!2sin"
                    width="100%"
                    height="300"
                    style={{ border: 0 }}
                    allowFullScreen
                    ...
                    className="grayscale hover:grayscale-0 transition-all duration-500 sm:h-[400px]"
                  />
                </div>
              </div>

              {/* Social Links */}
              <div className="bg-[#3730a3] rounded-2xl sm:rounded-3xl p-5 sm:p-8 text-white">
                ...
                <div className="flex gap-3 sm:gap-4">
                  {socials.map((social) => (
                    ...
                    >
                      ...
                      {social.name === 'tiktok' && (
                        <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M19.589 6.686a4.793 4.793 0 0 1-3.77-4.115V2h-3.193v13.766c0 1.338-1.066 2.426-2.378 2.426s-2.378-1.088-2.378-2.426c0-1.338 1.066-2.426 2.378-2.426.258 0 .506.042.739.12V10.21a5.574 5.574 0 0 0-.739-.05A5.63 5.63 0 0 0 4.62 15.79 5.63 5.63 0 0 0 10.248 21a5.63 5.63 0 0 0 5.628-5.21V8.687a7.957 7.957 0 0 0 4.124 1.145V6.64c-.14.015-.274.046-.411.046z" />
                        </svg>
                      )}
