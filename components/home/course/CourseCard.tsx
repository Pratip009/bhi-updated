...
const CourseCard = ({ course }: Props) => {
    ...
    const getCategoryBadgeStyle = (category: string) => {
        ...
        return styles[lowerCategory] || 'bg-gray-100 text-gray-700 border-gray-300';
    };
                ...
                <div className="bg-white rounded-lg overflow-hidden cursor-pointer hover:shadow-2xl transition-shadow duration-300">
                    ...
                    <div className="p-4">
                        ...
                        <div className="flex items-center mt-1 space-x-4">
                            <span className={`px-3 py-1 rounded-full text-sm font-semibold border ${getCategoryBadgeStyle(course.category)}`}>
                                {course.category}
                            </span>
